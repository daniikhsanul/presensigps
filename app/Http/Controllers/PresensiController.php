...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($cek > 0){
            ...
            if($update){
                ...
                echo "error|Maaf, Presensi Gagal, Silahkan Hubungi Teknisi|out"; 
            } 
      } else {
        $data = [
            'nik' => $nik,
        ...
        if($simpan){
            echo "success|Terimakasih, Selamat Bertugas|in";
            Storage::put($file, $image_base64);        
        }else{ 
            echo "error|Maaf, Presensi Gagal, Silahkan Hubungi Teknisi|in"; 
            }    
         }  
     }
}
    ...
    public function cetaklaporan(Request $request){
        ...
        ->whereRaw('MONTH(tgl_presensi)="' . $bulan . '"')
        ->whereRaw('YEAR(tgl_presensi)="' . $tahun . '"')
        ->orderBy('tgl_presensi') //ascending
        ->get();

        //coding convert excel
